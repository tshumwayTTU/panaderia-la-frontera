...
## Project Name
Panadería La Frontera Website Project
...
- `style.css`: one stylesheet for both pages. Warm palette (terracotta, cream, deep brown), serif headings, and spacing tuned for readability.
- `README.md`: the repository's front door. Explains the project and links to the live site and the docs folder.
...
- A single, consistent stylesheet.
- A shared header that lets visitors move between the two pages.
- All three documents in `docs/` are specific, detailed, and free of filler.
- Submission delivered by May 8, 2026 at 11:59 PM.

## Time
Due Friday, May 8, 2026 at 11:59 PM.

## Quality
"Done" means all the following are true:

- Every desired result above is met, and no exclusion is violated.
...
## Budget
$0. Everything I'm using is free: VS Code, Git, GitHub, the browser, Google Fonts or system fonts, and freely licensed imagery.

## Priorities
**Quality: 1. Time: 2. Budget: 3.**

Quality comes first because the rubric grades on specificity and polish, and because I want this repo to hold up as a portfolio piece once the semester ends. Time is a close second. May 8 doesn't move, so the project has to finish on time, but not by lowering the bar. Budget ranks last because it's already $0 with no flexibility either way.

## Exclusions
- **No JavaScript or interactivity:** No forms, no carousels, and no animations beyond simple CSS transitions.
- **No backend, database, or server-side logic:** No working contact form, no order processing, and no user accounts.
- **No CSS frameworks** (Bootstrap, Tailwind, etc.): I'm writing CSS from scratch.
...
- I submit a link to the public GitHub repository by May 8, 2026 at 11:59 PM.
- The repo contains `README.md`, `index.html`, `about.html`, `style.css`, and a `docs/` folder with `scope.md`, `plan.md`, and `retrospective.md`, all at the paths the assignment specifies.
- The instructor's final grade against the published rubric is the formal sign-off.
